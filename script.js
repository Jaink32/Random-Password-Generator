...
function generatePassword(){
    ...
    characters += lowercasEl.checked ? lowercaseLetters : "";
    characters += uppercasEl.checked ? uppercaseLetters : "";
...
function updatePasswordIndicator(){
    ...
    pasIndicator.className = "pass-indicator " + passwordStrength;
    console.log(pasIndicator.className);
